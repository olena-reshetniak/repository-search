...
class _HomeViewState extends State<HomeView> {
  ...
  void _onUpdateFavoriteStatus(
    ...
    context.read<HomeBloc>().add(HomeEvent.updateFavoriteList(repository));
  }
  ...
  void _openFavoriteListScreen(
    ...
    context.read<HomeBloc>().add(const HomeEvent.showSearchHistory());
    context.read<HomeBloc>().add(HomeEvent.search(state.searchValue));
  }
}
